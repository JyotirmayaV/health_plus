...
//String appBarName = "Meditation";
String currentState = "";

/// Creates [YoutubePlayerDemoApp] widget.
class YoutubePlayerDemoApp extends StatefulWidget {
  YoutubePlayerDemoApp({@required this.currentsState});

  final String currentsState;
...
class _YoutubePlayerDemoAppState extends State<YoutubePlayerDemoApp> {
  ...
  void initState() {
    setState(() {
      ...
      print("app current state is $currentState");
    });
  }
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  static List<String> _ids = currentState == "Meditation"
              ...
              child: Column(
                ...
                children: [
                  ...
                  AnimatedContainer(
                    ...
                    padding: const EdgeInsets.all(8.0),
                    child: Text(
                      _playerState.toString().split(".").last.toLowerCase(),
                      style: const TextStyle(
                        fontWeight: FontWeight.w300,
                        color: Colors.white,
                      ),
